 ...
 *
 * @package     AutomatorWP\Integrations\HappyForms\Triggers\Anonymous_Submit_Form
...
class AutomatorWP_HappyForms_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {

    public $integration = 'happyforms';
    public $trigger = 'happyforms_anonymous_submit_form';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest submits a form', 'automatorwp-happyforms' ),
            'select_option'     => __( 'Guest submits <strong>a form</strong>', 'automatorwp-happyforms' ),
            /* translators: %1$s: Post title. */
            'edit_label'        => sprintf( __( 'Guest submits %1$s', 'automatorwp-happyforms' ), '{post}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'Guest submits %1$s', 'automatorwp-happyforms' ), '{post}' ),
...
new AutomatorWP_HappyForms_Anonymous_Submit_Form();