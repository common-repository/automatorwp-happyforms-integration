...
Tags: happy, forms, automatorwp, submission, contact
...
Connect AutomatorWP with HappyForms
...
[HappyForms](https://wordpress.org/plugins/happyforms/ "HappyForms") is a free form-builder plugin that allows you to easily build contact forms for your WordPress-powered website.

This plugin automatically connects [AutomatorWP](https://wordpress.org/plugins/automatorwp/ "AutomatorWP") with HappyForms adding new triggers that you can use to connect with other plugins and automate workflows letting you save time and get focused on your most important work.
...
[Pro version](https://automatorwp.com/add-ons/happyforms/ "AutomatorWP - HappyForms") available that let's you expand the integration between AutomatorWP and HappyForms bringing you more ways to automatize your website forms.
...
* **Improvements**
* Added support to detect HappyForms pro.
